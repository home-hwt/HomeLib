...
public class HomeHttpRequestRetryHandler implements HttpRequestRetryHandler {
	...
	public HomeHttpRequestRetryHandler(int maxRetries) {
	...
	public boolean retryRequest(IOException exception, int retriedTimes,
		...
		if (retry) {
			try {
				...
				retry = false;
				GHLog.gHLog(GHLog.LOG_ERROR, "retry error");
			}
		}
